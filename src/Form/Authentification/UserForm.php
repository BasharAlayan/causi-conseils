...
use App\Entity\User;
use App\Form\TagsType\CenterInterestsTags;
use App\Form\TagsType\CompetenciesTags;
use App\Form\TagsType\ProfessionsTags;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('country', CountryType::class, [
                'label' => 'Votre pays',
                'attr' => ['class' => 'form-control',]])
            ->add("TagsCenterInterest", CenterInterestsTags::class, [
                'label' => 'centre d\'intérêts',
                'required'   => true,
                'attr' => ['class' => 'tag-input',
                ]])
            ->add("TagCompetencie", CompetenciesTags::class, [
                'label' => 'compétences',
                'required'   => true,
                'attr' => ['class' => 'tag-input',
                ]])
            ...
            ->add('TagProfession', ProfessionsTags::class, [
                'label' => ' Vos metiers',
                'required'   => true,
                'attr' => ['class' => 'tag-input',]])
